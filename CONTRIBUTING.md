# Contributing to finsage

Thank you for your interest in contributing to finsage! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/finsage.git
   cd finsage
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/finsage.git
   ```
...
By contributing to finsage, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
